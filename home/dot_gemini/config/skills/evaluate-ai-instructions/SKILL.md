...
3. **Perform the required analyses** (report only if there is strong evidence):
   ...
   - **Cognitive Load**: Find overly complex instruction patterns (deeply nested conditions, competing priorities) and flag any "conversational persuasion"—rules that attempt to justify themselves rather than just stating an imperative constraint. Explain why this increases cognitive load or makes the instructions harder for the model to follow.
