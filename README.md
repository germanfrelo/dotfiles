...
- **Auto-generated documentation** — `npm run chezmoi:sync` reads `home/.chezmoi.toml.tmpl` and injects a "My configuration" table into `docs/chezmoi.md` and a machine-readable TOML block into `AGENTS.md`, so both always reflect the actual chezmoi setup without manual editing.
...
| `chezmoi:sync` | Injects auto-generated config sections into `docs/chezmoi.md` and `AGENTS.md` |
